...
namespace mvk
{
    ...
    VkImageSubresourceRange createSubresourceRange(const ImageAspectFlags aspect = ImageAspectFlags(ImageAspect::Color),
    ...
    VkComponentMapping createComponentMapping(VkComponentSwizzle r = VK_COMPONENT_SWIZZLE_IDENTITY,
